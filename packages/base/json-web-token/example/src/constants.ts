...
const PKGJSON_CONTENT = fs.readFileSync(PKGJSON_PATH, 'utf8');
export const PKGJSON_INFO = JSON.parse(PKGJSON_CONTENT);
export const USER_INFO_PAYLOAD = {
  sub: '0987654321',
  name: 'John Doe',
  role: 'admin',
...
export const SAMPLE_SECRETS: Record<string, string | JWK> = {
  pkcs8: SAMPLE_PKCS8,
  jwk: SAMPLE_JWK,
  secret: SAMPLE_SECRET_TEXT,
};

export const KEY_ALG_MESSAGES: Record<string, string> = {
  Ed25519: 'Ed25519 key',
  'NIST.P-256': 'NIST P-256 elliptic curve key',
  'NIST.P-384': 'NIST P-384 elliptic curve key',
  'NIST.P-521': 'NIST P-521 elliptic curve key',
  'secret.32byte': '256 bit (32 byte) secret',
  'secret.48byte': '384 bit (48 byte) secret',
  'secret.64byte': '512 bit (64 byte) secret',
  RSA: 'RSA key of at least 2048 bit modulus length',
};
